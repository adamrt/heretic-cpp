...
SRC_FILES = src/main.cpp src/Camera.cpp src/GUI.cpp src/Renderer.cpp src/Model.cpp src/Light.cpp src/Scene.cpp src/Texture.cpp src/Mesh.cpp src/State.cpp
